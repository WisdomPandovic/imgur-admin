        ...
        <div>
             <form className="form-content" onSubmit={updateProducts}>
                <div className="form-control">
                    ...
                    <input type="file" value={updateProduct.image} onChange={(e) => setProduct( {...updateProduct, image: e.target.files[0]})}/>
                ...
                <div className="form-control">
                    ...
                    <input type="text" value={updateProduct.tag ?? ''} onChange={(e) => setProduct({ ...updateProduct, tag: e.target.value })} />
